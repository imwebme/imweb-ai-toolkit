...
public snapshot에서 직접 보존하는 것은 설치 경로와 문서 정합성입니다.

- `docs/public-export-allowlist.json`
  - public snapshot에 포함할 경로만 source of truth로 고정합니다.
...
- 문서 정합성
  ...
  - allowlisted 문서는 allowlist 밖 경로를 다시 참조하지 않아야 합니다.
