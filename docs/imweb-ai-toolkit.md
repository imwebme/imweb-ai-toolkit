...
- 공개 skill `imweb`
- 표면별 plugin metadata와 marketplace metadata
- 설치, 업데이트, plugin install/package, bootstrap 스크립트
...
- `.agents/plugins/marketplace.json`
  - Codex App/CLI에서 plugin으로 설치할 수 있도록 repo marketplace를 둡니다.
- `.claude-plugin/`
  - Claude Code와 Claude Desktop Cowork용 기본 메타데이터를 둡니다.
...
- `install/`
  - CLI 설치기, skill 설치기, plugin 설치/패키징, bootstrap 진입점을 둡니다.
- `examples/`
